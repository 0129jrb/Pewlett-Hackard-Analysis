-- Creating tabeles for PH-EmployeeDB
...
CREATE TABLE dept_manager(dept_no VARCHAR(4) NOT NULL,
						 emp_no INT NOT NULL,from_date DATE NOT NULL,
...
SELECT first_name, last_name
FROM employees
WHERE brith_date BETWEEN '1953-01-01' AND '1953-12-31';

SELECT first_name, last_name
FROM employees
WHERE brith_date BETWEEN '1954-01-01' AND '1954-12-31';

SELECT first_name, last_name
FROM employees
WHERE brith_date BETWEEN '1955-01-01' AND '1955-12-31';
